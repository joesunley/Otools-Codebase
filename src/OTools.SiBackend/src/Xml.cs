...
namespace OTools.SiBackend
{
    public sealed class XMLDocument
    {
        ...
        {
            Sys.XmlDocument doc = new Sys.XmlDocument();
            doc.LoadXml(xml);
    ...
    public sealed class XMLNode
    {
        ...
        {
            Name = "";
            _children = new XMLNodeCollection();
    ...
    internal static class Marshall
    {
        ...
        {
            XMLNode outNode = new XMLNode(node.Name);
        ...
        {
            XElement outEl = new XElement(node.Name);
